...
function createCard(object){
  ...
  card.append(userImg, cardInfo, cardTitle, userName, userLocation, userProfile, profileLink, followerCount, followingCount, userBio);
  ...
  userLocation.textContent = userLocation;
